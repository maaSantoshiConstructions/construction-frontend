    ...
    <footer className="bg-slate-900 text-slate-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            <Link to="/" className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-700 rounded-2xl flex items-center justify-center shadow-inner">
            ...
            <div className="flex gap-3">
              {['facebook', 'instagram', 'youtube', 'whatsapp'].map((social) => (
                <a key={social} href="#" className="w-9 h-9 bg-slate-800 hover:bg-blue-600 rounded-full flex items-center justify-center transition-colors text-sm capitalize">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex gap-3">
                <FaMapMarkerAlt className="mt-0.5 text-blue-400 shrink-0" />
              ...
              <li className="flex gap-3">
                <FaClock className="mt-0.5 text-blue-400 shrink-0" />
      ...
      <div className="border-t border-slate-800">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-slate-500">
          ...
          <p>
            Powered by{' '}
            <a href="https://briskode.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 transition-colors">
              Briskode Technology
            </a>
          </p>
        </div>
